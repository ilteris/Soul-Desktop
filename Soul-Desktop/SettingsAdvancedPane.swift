...
struct AdvancedPane: View {
    ...
    @AppStorage("soul.toolCallTimeout.seconds") private var toolCallTimeout: Int = 300
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            ...
            StepperRow(title: "Gemini-CLI",
                       description: "Default 240s. Higher than Claude because gemini-cli's tool-call streams routinely run long on bigger repos.",
                       value: $geminiBudget,
                       range: 30...600,
                       suffix: "seconds")
            StepperRow(title: "Claude",
                       description: "Default 180s. Claude's most common stall mode is the end-of-turn omission after \"waiting for your go-ahead\" replies.",
                       value: $claudeBudget,
                       range: 30...600,
                       suffix: "seconds")
            StepperRow(title: "Pi",
                       description: "Default 300s. Pi's local-agent turns trend slower; keep this conservative until we have more signal.",
                       value: $piBudget,
                       range: 30...600,
                       suffix: "seconds")
            ...
            StepperRow(title: "Auto-cancel ceiling",
                       description: "Default 900s (15 min). Set to a high value to disable; the manual Recover capsule still works.",
            ...
            StepperRow(title: "Per-tool-call timeout",
                       description: "Default 300s. Shell/execute tools get at least 900s because repo-wide searches and builds can be quiet for several minutes.",
